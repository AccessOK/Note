...
public class JnaTerminalProvider implements TerminalProvider
{
    ...
    public Pty current(SystemStream console) throws IOException {
    ...
    public Terminal sysTerminal(String name, String type, boolean ansiPassThrough, Charset encoding,
                                ...
                                SystemStream consoleStream, Function<InputStream, InputStream> inputStreamWrapper) throws IOException {
