...
class PlatformProps {
    ...
    static final boolean TARGET_OS_IS_LINUX   = "linux" == "linux";
    static final boolean TARGET_OS_IS_MACOS   = "linux" == "macos";
    static final boolean TARGET_OS_IS_WINDOWS = "linux" == "windows";
    static final boolean TARGET_OS_IS_AIX     = "linux" == "aix";
    ...
    static final boolean TARGET_ARCH_IS_PPC     = "x64" == "ppc";
    static final boolean TARGET_ARCH_IS_PPC64   = "x64" == "ppc64";
    static final boolean TARGET_ARCH_IS_PPC64LE = "x64" == "ppc64le";
    static final boolean TARGET_ARCH_IS_RISCV64 = "x64" == "riscv64";
    static final boolean TARGET_ARCH_IS_S390    = "x64" == "s390";
    static final boolean TARGET_ARCH_IS_SPARCV9 = "x64" == "sparcv9";
